        ...
        <div className="why-container">
            <div className="why-container-inner">
                <div className="why-container-left">
                    <h2>Why Verizone?</h2>
                    <p>
                        Our expert property verification services are designed to provide you with
                        peace of mind, clarity, and protection against potential risks. Whether
                        you’re a home buyer, investor, or seller, we’re here to help you make
                        confident, informed decisions.
                    </p>
                    <img src="./About-Why.svg" />
                </div>
                <div className="why-container-right">
                    <div>
                        <p>To three reasons</p>
                        <span>
                            why thousands trust us for reliable, accurate, and timely verification.
                        </span>
                    </div>
                    <div className="pe-cicrle">
                        <div className="div-cicrle">
                            <div className="div-cicrle-child-1">
                                <img src="public/Frame 1000004413.png" alt="" className="cicrle" />
                            </div>
                            <div>
                                <p>Dispute Check</p>
                                <span>
                        ...
                        <div className="div-cicrle">
                            ...
                            <div>
                                <p>Validation</p>
                                <span>
                                    Confirm the rightful owner of any property before closing deals.
                                    Avoid the costly mistakes of falling for fraudulent claims.
                                </span>
                            </div>
                        </div>
                        <div className="div-cicrle">
